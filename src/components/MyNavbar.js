...
function MyNavbar(props) {
  ...
  const themenames = ['dark', 'dark', 'dark', 'dark', 'light', 'light', 'light']
  ...
  const newNav = (
    <>
      <Navbar
        variant={themenames[index]}
        className="d-flex justify-content-between"
        style={{ fontSize: '12px' }}
      >
        <Navbar.Brand href="/" className="w-25">
          {props.location.pathname === '/mall' ? (
            ''
          ) : (
            <img
              src={
                locationPathname === '/membercenter'
                  ? '/mano_logo_light-01.svg'
                  : '/mano_logo_dark-01.svg'
              }
              alt="mano"
              style={{ height: '30px' }}
            />
        ...
        <div>
          <Nav className="mr-auto">
            ...
            <Nav.Link
              ...
              onMouseEnter={() => setLifeShow(true)}
              onMouseLeave={() => setLifeShow(false)}
              onClick={() => setLifeShow(false)}
            >
              抹茶新生活
              {lifeShow ? (
                <div
                  className="d-flex justify-content-center nav-show-box"
                  style={{
                    position: 'absolute',
                    width: '185px',
                    left: '0',
        ...
        <Nav className="w-25 d-flex justify-content-end">
          <Form inline>
            {member[0].memberName !== '' ? (
              <>
                {locationPathname === '/membercenter' ? (
                  ...
                  <span
                    style={{ color: '#5C6447', opacity: '0.7' }}
                    className="mr-2"
                  >
                    {member[0].memberName} , 您好
                  </span>
                ...
                <Nav.Link
                  as={NavLink}
                  to="/mall/membercenter"
                  style={{ width: '32px', position: 'relative' }}
                  onMouseEnter={() => setCenterShow(true)}
                  onMouseLeave={() => setCenterShow(false)}
                  onClick={() => setCenterShow(false)}
                >
                  <Image
                    style={{
                      width: '20px',
                  ...
                  {centerShow ? (
                    ...
                    >
                      ...
                      >
                        <img
                          src="/hover_list/hover_list-04.svg"
                          alt="會員中心"
                        />
                      </Nav.Link>
                      <Nav.Link
            ...
            <Nav.Link as={NavLink} to="/mall/cart" style={{ width: '32px' }}>
              {locationPathname === '/membercenter' ? (
                <MdShoppingCart
                  className="cWhite hover-op"
                  style={{ fontSize: '24px' }}
                />
              ) : (
                <MdShoppingCart
                  className="cGreen hover-op"
                  style={{ fontSize: '24px' }}
                />
              )}
            </Nav.Link>
      ...
      <Navbar variant={themenames[index]} className="mt-5">
        <Nav className="cartNav text-center justify-content-center align-items-center">
          <Nav.Link
            ...
            className={
              props.history.location.pathname === '/mall/cart' ||
              props.history.location.pathname === '/life/cart'
                ? 'w-25 cartNav-list cartNav-active'
                : 'w-25 cartNav-list'
            }
            disabled
            exact
          ...
          <Nav.Link
            as={NavLink}
            className={
              props.history.location.pathname === '/mall/cart/comfirm' ||
              props.history.location.pathname === '/life/cart/comfirm'
                ? 'w-25 cartNav-list cartNav-active'
                : 'w-25 cartNav-list'
            }
            to={
          ...
          <Nav.Link
            as={NavLink}
            className={
              props.history.location.pathname === '/mall/cart/payment' ||
              props.history.location.pathname === '/life/cart/payment'
                ? 'w-25 cartNav-list cartNav-active'
                : 'w-25 cartNav-list'
            }
            to={
          ...
          <Nav.Link
            as={NavLink}
            className={
              props.history.location.pathname === '/mall/cart/complete' ||
              props.history.location.pathname === '/life/cart/complete'
                ? 'w-25 cartNav-active'
                : 'w-25'
            }
            to={
  ...
  else if (path === '/change' || path === '/' || path === '/404')
    displayNav = ''
